    ...
    <div className="w-full min-h-[calc(100vh-100px)] bg-primary">
        <div className="w-full h-[100px] flex justify-center items-center">
            ...
            onChange={async(e)=>{
             ...
             placeholder="Search products..." className="px-4 py-2 rounded-xl bg-white/80 border border-secondary/10 outline-none focus:ring-2 focus:ring-accent/50 w-full max-w-md" />
        </div>
        {
            isLoading ? <Loader />
            :
