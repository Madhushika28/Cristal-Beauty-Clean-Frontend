    ...
    <div className="w-full bg-gradient-to-b from-[var(--color-primary)] via-[var(--color-primary)]/95 to-white/10 px-6 py-16 md:py-24">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <h1 className="text-[var(--color-secondary)] text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Contact{" "}
          <span className="text-[var(--color-accent)]">Cristal Beauty</span>
        </h1>
          ...
          <div className="relative bg-gradient-to-br from-white to-white/95 backdrop-blur-md border border-white/40 rounded-3xl shadow-2xl p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <a
                ...
                className="group/card bg-gradient-to-br from-white to-white/80 backdrop-blur-sm border border-white/30 rounded-2xl p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-xl text-[var(--color-secondary)] mb-2">
                    Phone Number
                  </h3>
                  <p className="text-[var(--color-secondary)]/70 mb-3">
                    Call us anytime
                  </p>
              ...
              <a
                href="mailto:support@cristalbeauty.com?subject=Contact%20Cristal%20Beauty"
                className="group/card bg-gradient-to-br from-white to-white/80 backdrop-blur-sm border border-white/30 rounded-2xl p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
              >
                <div className="flex flex-col items-center text-center">
                  <div className="mb-4 bg-gradient-to-br from-[var(--color-accent)]/20 to-[var(--color-accent)]/10 p-4 rounded-full group-hover/card:scale-110 transition-transform duration-300">
                  ...
                  <span className="text-lg font-semibold text-[var(--color-accent)] break-all">
                    support@cristalbeauty.com
                  </span>
                </div>
              </a>
                ...
                <div className="relative group/input">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      pattern="[0-9]{10}"
                      title="Please enter a valid 10-digit Sri Lankan mobile number"
                      maxLength="10"
                      onInput={(e) => {
      ...
      <div className="max-w-4xl mx-auto mt-20 text-center">
        <div className="bg-gradient-to-r from-[var(--color-accent)]/10 to-transparent backdrop-blur-sm border border-white/30 rounded-2xl p-8">
          ...
          <p className="text-[var(--color-secondary)]/70 text-lg">
            Our team typically responds within 2-4 hours during working hours.
