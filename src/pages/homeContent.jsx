            ...
            <div className="relative group">
              ...
              <div className="relative bg-black/40 backdrop-blur-md border border-white/20 rounded-3xl p-8 lg:p-10 shadow-2xl">
                ...
                <p className="text-white/80 text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl">
                  Discover our range of premium skincare, nourishing haircare, and high-quality 
                  cosmetic products, each carefully crafted with safe and effective ingredients 
                  to enhance your natural beauty and provide a luxurious self-care experience.
                </p>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-[var(--color-secondary)] mb-6">
            The Cristal Beauty <span className="text-[var(--color-accent)]">Promise</span>
          </h2>
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/90 text-lg lg:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
            Trusted cosmetic products loved across Sri Lanka, designed to enhance 
            your beauty and confidence every single day. Join thousands of satisfied 
            customers who have transformed their beauty routine.
          </p>
