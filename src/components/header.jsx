    ...
    return (
        <header className="w-full bg-accent h-[100px] text-white px-[40px] shadow-md">
            <div className="w-full h-full flex relative items-center">
                ...
                {isSideBarOpen && (
                    <div 
                        className="fixed top-0 left-0 w-full h-screen bg-black/70 text-secondary z-[100]"
                        onClick={() => setIsSidebarOpen(false)}
                    >
                        <div 
                            className="w-[300px] bg-primary h-full flex flex-col relative shadow-xl"
                        ...
                        >
                            ...
                            <Link 
                                to="/" 
                                className="p-4 border-b border-secondary/10 rounded-lg mx-2 my-1 hover:bg-accent hover:text-white transition text-center block"
                                onClick={() => setIsSidebarOpen(false)}
                            >
                                Home
                            </Link>
